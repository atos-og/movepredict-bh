...
function LoadingRoute({ destination }: { destination: string }) {
  return <main className="roadmap-page route-page"><AppHeader title={destination} backHref="/" /><section className="roadmap-unavailable"><RefreshCw className="spin" size={30} /><h2>Montando sua melhor rota</h2><p>Combinando caminhada, linhas, horarios e previsoes disponiveis.</p></section></main>;
}
