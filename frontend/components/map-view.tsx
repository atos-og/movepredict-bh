...
function ViewportController({ selectedStop, route }: Pick<Props, "selectedStop" | "route">) {
  const map = useMap();
...
export default function MapView({
  ...
  return (
    <MapContainer center={BH_CENTER} zoom={13} className="map" zoomControl attributionControl>
      ...
      />
      <ViewportController selectedStop={selectedStop} route={route} />
      {showRoute && positions && (
